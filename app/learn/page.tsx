...
export default function LearnPage() {
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="max-w-3xl mx-auto py-8 px-2 sm:py-12 sm:px-4">
        {/* Hero Section */}
        <section className="mb-10 sm:mb-12 text-center">
          ...
          <a
            href="#pricing"
            className="inline-block w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-lg text-lg font-semibold shadow hover:bg-indigo-700 transition mb-2"
          >
        ...
        <section className="mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-zinc-200 rounded-xl p-4 sm:p-6 shadow-sm w-full break-words">
        ...
        <section className="mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-zinc-200 rounded-xl p-4 sm:p-6 shadow-sm text-center w-full break-words">
        ...
        <section id="pricing" className="mb-10 sm:mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border border-zinc-200 rounded-xl p-4 sm:p-6 shadow-sm text-center w-full break-words">
              ...
              <a
                href="#"
                className="block w-full bg-indigo-600 text-white py-3 rounded-lg font-semibold hover:bg-indigo-700 transition mt-2 sm:mt-0"
              >
                Reserve My Spot
              </a>
            </div>
            <div className="bg-white border-2 border-indigo-500 rounded-xl p-4 sm:p-6 shadow-sm text-center w-full break-words">
          ...
          <p className="text-center text-zinc-500 mt-4 sm:mt-6 text-sm">Limited spots per session. Replay included.</p>
        </section>
        ...
        <section className="mb-10 sm:mb-12">
          ...
          <div className="space-y-4">
            <details className="bg-white border border-zinc-200 rounded-xl p-4 shadow-sm w-full break-words">
        ...
        <section className="mb-14 sm:mb-16">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 bg-white border border-zinc-200 rounded-xl p-4 sm:p-6 shadow-sm w-full break-words">
        ...
        <section className="py-8 sm:py-12 text-center">
          ...
          <a
            href="#pricing"
            className="inline-block w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-lg text-lg font-semibold shadow hover:bg-indigo-700 transition"
          >
